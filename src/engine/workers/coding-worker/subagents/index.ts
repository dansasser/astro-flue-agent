...
import { createCodingTriageTools } from '../../../../engine/workers/coding-worker/tools/coding-triage-tools.js';
import { createCodingCodeReviewSubagent, codingCodeReviewSubagentName } from '../../../../engine/workers/coding-worker/subagents/code-review/code-review-agent.js';
import { createCodingGithubSubagent, codingGithubSubagentName } from '../../../../engine/workers/coding-worker/subagents/github/github-agent.js';
import { createCodingImplementerSubagent, codingImplementerSubagentName } from '../../../../engine/workers/coding-worker/subagents/implementer/implementer-agent.js';
import { createCodingTestDebugSubagent, codingTestDebugSubagentName } from '../../../../engine/workers/coding-worker/subagents/test-debug/test-debug-agent.js';
import { createCodingTriageSubagent, codingTriageSubagentName } from '../../../../engine/workers/coding-worker/subagents/triage/triage-agent.js';
