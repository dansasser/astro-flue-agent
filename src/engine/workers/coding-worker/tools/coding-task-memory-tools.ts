...
import type { CodingPlanItem } from '../../../../engine/workers/coding-worker/types.js';
import { toRetrievedContext } from '../../../../engine/memory/checklist-memory-provider.js';
import type { CodingApprovalService } from '../../../../engine/workers/coding-worker/approvals/approval-service.js';
import { recordCodingAuditEvent } from '../../../../engine/workers/coding-worker/approvals/approval-service.js';
import { recordMemoryMutationEvent, type MemoryMutationEvent } from '../../../../core/telemetry/flue-telemetry.js';
import {
