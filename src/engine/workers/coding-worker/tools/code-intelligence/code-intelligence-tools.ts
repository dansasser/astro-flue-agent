...
import { fileExtensionToLanguageId } from '../../../../../engine/workers/coding-worker/tools/code-intelligence/lsp/lsp-server-registry.js';
import { parseFile, type ParseResult } from '../../../../../engine/workers/coding-worker/tools/code-intelligence/ast-parser.js';
import {
  addToImportGraph,
  createImportGraph,
  findDependencies,
