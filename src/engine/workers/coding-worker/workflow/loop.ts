...
import type { ApprovalEventBridge } from '../../../../api/ingress/approval-event-bridge.js';
import { BridgeCodingProgressReporter } from '../../../../api/ingress/approval-event-bridge.js';
import { InMemoryCodingProgressReporter, type CodingProgressReporter } from '../../../../engine/workers/coding-worker/events/progress-reporter.js';
...
import { parseVerificationCommandFailures } from '../../../../engine/workers/coding-worker/repo/verification.js';
import { resolveCodingWorkspaceTarget, type ResolvedCodingWorkspaceTarget } from '../../../../engine/workers/coding-worker/repo/workspace-target.js';
...
} from '../../../../engine/workers/coding-worker/session/task-run-store.js';
import {
...
function checkpointStatusForStep(step: CodingWorkerLoopStep): import('../../../../engine/workers/coding-worker/session/task-run-store.js').CodingTaskRunStatus {
  switch (step) {
    case 'triage':
      return 'triaging';
    case 'implement':
