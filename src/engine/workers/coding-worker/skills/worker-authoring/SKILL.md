...
Create a Flue `defineAgentProfile(...)` entrypoint and a worker-owned `workspace/AGENTS.md`. Keep the worker specialized, attach only capabilities it owns, and return structured results and public progress rather than hidden internal reasoning.
