...
These are the capabilities that sit **above** the
[Finish the Coding Worker Product plan](coding-worker-finish-plan.md). They move
the agent from "production-usable" to "top-notch" — comparable to the most
