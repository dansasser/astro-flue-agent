<!-- development-graph-sha256: 7f2d3756e9032853ae3874e5a70ca2474a9ad9f04c05bf2755983de703d2ae0f -->
...
| Project root | `.` |
| Context version | `capability-protocol-validation:2026-07-29` |
...
| Canonical checksum | `7f2d3756e9032853ae3874e5a70ca2474a9ad9f04c05bf2755983de703d2ae0f` |
...
- Acceptance:
  ...
  - `open-decisions-isolated` (policy): D4 blocks only its named consumer, while resolved D1, D2, D3, D5, and D6 are consumed by planning, verification, and every declared affected implementation or release member. Evidence: `runtime:evidence/verify-release-reconciliation-specifications/open-decisions-isolated.json`
