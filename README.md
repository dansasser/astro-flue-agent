...
| Workflows and schedules | Agent workflows and messaging automation support repeated tasks | Cron scheduling and reusable skills/workflows support recurring automation | Schedules trigger durable orchestrator turns; trusted event handoff for protocol and scoped-memory access remains a release gate |
