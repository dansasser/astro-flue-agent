...
| Runpod image | `RUNPOD_API_KEY`, `RUNPOD_API_BASE_URL`, `RUNPOD_IMAGE_MODELS_PATH`, `GOROMBO_IMAGE_OUTPUT_DIR` | key yes | Runpod image tool |
...
`SIM_ONE_PRODUCT_PATH`, `SIM_ONE_TEST_CWD_MARKER`,
